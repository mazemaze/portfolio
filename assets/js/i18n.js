...
const I18N = {
  en: {
    ...
    "hero.role": "Full-Stack Engineer · PM · Tech Lead",
    ...
    "skills.g.cloud": "Cloud & Data",
    "skills.g.ai": "AI & Tools",
    "skills.g.process": "Process",
    ...
    "work.title": "Work",
    "work.lead": "Three projects, told the way clients ask about them: the challenge, what I did, and the result.",
    "work.challenge": "Challenge",
    "work.did": "What I did",
    "work.result": "Result",
    "work.1.title": "Web3 App for the G7 in Hokkaido",
    "work.1.role": "Development Lead",
    "work.1.field": "Web3 · International event",
    "work.1.figure": "~4 mo.",
    "work.1.figureLabel": "From zero to release",
    "work.1.challenge": "Build a Web3 app for the G7 in Hokkaido, starting from zero.",
    "work.1.did": "Led development end to end: designed the data and the app, selected and managed the designer, built it and took it to release.",
    "work.1.result": "Released in about four months from a standing start.",
    "work.2.title": "AI Fitness App",
    "work.2.role": "PM · Lead Engineer",
    "work.2.field": "Fitness · AI",
    "work.2.figure": "0→1",
    "work.2.figureLabel": "Zero-to-one phase, led as PM",
    "work.2.challenge": "Take a new fitness app with AI chat and voice from zero to one.",
    "work.2.did": "Ran requirements and system design as PM. Chose and built the AI chat and voice systems on the OpenAI API, designed the whole frontend architecture, and set up the code-review process.",
    "work.2.result": "Took the app through its zero-to-one phase with AI chat and voice built in.",
    "work.3.title": "Advertising Keyboard App",
    "work.3.role": "Lead Engineer",
    "work.3.field": "Advertising · Mobile",
    "work.3.figure": "~10%",
    "work.3.figureLabel": "Rise in user retention",
    "work.3.challenge": "Keep a live app improving while running its maintenance, operations and new features.",
    "work.3.did": "Led maintenance, operations and new features, and shipped improvement proposals quickly. Built tools that made the team's work more efficient, and handled hiring, training and DevOps.",
    "work.3.result": "User retention rose by about 10%.",
  ...
  ja: {
    ...
    "hero.name": "ヒカワ ユウジロウ",
    "hero.role": "フルスタックエンジニア · PM · テックリード",
    ...
    "work.title": "実績",
    "work.lead": "3つのプロジェクトを、課題・取り組み・結果で紹介します。",
    "work.challenge": "課題",
    "work.did": "取り組み",
    "work.result": "結果",
    "work.1.title": "北海道G7向けWeb3アプリ",
    "work.1.role": "開発統括",
    "work.1.field": "Web3・国際会議",
    "work.1.figure": "約4ヶ月",
    "work.1.figureLabel": "ゼロからリリースまで",
    "work.1.challenge": "北海道G7に向けたWeb3アプリを、ゼロから開発する。",
    "work.1.did": "開発統括として、データ設計・アプリ設計、デザイナーの選定とマネジメント、開発、リリースまでを一貫して担当。",
    "work.1.result": "着手から約4ヶ月でリリースまで完遂。",
    "work.2.title": "AIフィットネスアプリ",
    "work.2.role": "PM・リードエンジニア",
    "work.2.field": "フィットネス・AI",
    "work.2.figure": "0→1",
    "work.2.figureLabel": "PMとして0→1フェーズを主導",
    "work.2.challenge": "AIチャットと音声機能を持つ新しいフィットネスアプリを、ゼロから立ち上げる。",
    "work.2.did": "PMとして要件定義・システム設計を主導。OpenAI APIを使ったAIチャット・音声システムを技術選定から実装まで担当し、フロントエンド全体のアーキテクチャ設計とレビュー体制を構築。",
    "work.2.result": "AIチャット・音声を組み込み、アプリを0→1フェーズまで立ち上げ。",
    "work.3.title": "広告業界 キーボードアプリ",
    "work.3.role": "リードエンジニア",
    "work.3.field": "広告・モバイル",
    "work.3.figure": "約10%",
    "work.3.figureLabel": "ユーザー継続率の上昇",
    "work.3.challenge": "運用中のアプリを保守・運用しながら、継続的に改善する。",
    "work.3.did": "リードとして保守・運用・追加機能開発を担当し、改善提案を素早くプロダクトに反映。業務効率化ツールを開発し、採用・教育・DevOpsも担当。",
    "work.3.result": "ユーザー継続率が約10%上昇。",
