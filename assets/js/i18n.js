...
const I18N = {
  en: {
    ...
    "work.1.when": "Ongoing",
    "work.1.figure": "Chat→App",
    "work.1.figureLabel": "From a conversation to a live app",
    "work.1.challenge": "Let people turn a conversation into a live app or landing page, with the right AI model for each job.",
    "work.1.did": "Founded Euthopia and lead its engineering: an AI platform that designs, builds, hosts and publishes apps and landing pages from a chat, and lets each job run on the model that suits it — OpenAI, Claude, Chinese models such as MiMo, and more.",
    "work.1.result": "Apps and landing pages are built and published on it, on models from several providers.",
  ...
  ja: {
    ...
    "work.1.when": "継続中",
    "work.1.figure": "会話→アプリ",
    "work.1.figureLabel": "会話から、公開されたアプリまで",
    "work.1.challenge": "会話だけで、アプリやランディングページを公開まで。仕事ごとに最適なAIモデルを使えるようにする。",
    "work.1.did": "Euthopiaを創業し、開発をリード。会話からアプリやLPを設計・構築・ホスティング・公開まで行うAIプラットフォームで、OpenAI・Claude・MiMoなどの中国系モデルを含む複数のAIモデルを、仕事ごとに選べる設計に。",
    "work.1.result": "複数プロバイダーのAIモデルで、実際にアプリやLPが構築・公開されている。",
