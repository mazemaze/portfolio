...
const I18N = {
  en: {
    ...
    "work.title": "Work",
    "work.lead": "Four projects: the challenge, what I did, and the result.",
    ...
    "work.1.result": "Started in February 2026 and officially released that April. 80+ apps and sites built on it.",
    "work.2.title": "Web3 App for the G7 in Hokkaido",
    "work.2.role": "Development Lead",
    "work.2.field": "Web3 · G7 Hokkaido",
    "work.2.figure": "~4 mo.",
    ...
    "work.3.did": "Ran requirements and system design as PM. Owned the AI chat and voice systems from technology selection to implementation, designed the whole frontend architecture, and set up the code-review process.",
    "work.3.result": "Led the app's zero-to-one phase, with AI chat and voice built in.",
    ...
    "work.4.did": "Led maintenance, operations and new features, and shipped improvement proposals quickly. Built internal tools to streamline operations, and handled hiring, training and DevOps.",
    ...
    "exp.6.title": "Web3 App for the G7 in Hokkaido",
    "exp.6.desc": "Shipped a Web3 app for the G7 in Hokkaido in roughly four months — from data and app design through designer selection and management, development, and launch.",
    ...
    "contact.resumeHref": "assets/yujiro-hikawa-cv.pdf",
    ...
    "contact.how.typeVal": "Freelance contract — from a single feature to a full product build",
  ...
  ja: {
    ...
    "work.did": "取り組み",
    "work.result": "結果",
    "work.1.title": "Euthopia — AIアプリ構築\u200bプラットフォーム",
    "work.1.role": "創業者・リードエンジニア",
    "work.1.field": "AI・アプリ構築",
    "work.1.when": "2026.02 — 現在",
    "work.1.figure": "80+",
    ...
    "work.1.result": "2026年2月に着手し、同年4月に正式リリース。80以上のアプリ・サイトが構築されている。",
    "work.2.title": "北海道G7向けWeb3アプリ",
    "work.2.role": "開発統括",
    "work.2.field": "Web3・北海道G7",
    "work.2.figure": "約4ヶ月",
    ...
    "work.3.did": "PMとして要件定義・システム設計を主導。AIチャット・音声システムを技術選定から実装まで担当し、フロントエンド全体のアーキテクチャ設計とレビュー体制を構築。",
    "work.3.result": "PMとして0→1フェーズを主導し、AIチャット・音声を実装。",
    ...
    "contact.how.typeVal": "業務委託（フリーランス）— 一機能からプロダクト全体まで",
    "contact.how.lang": "言語",
