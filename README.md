...
cv/cv-en.html              # English CV source; cv/build.sh prints it to assets/cv-en.pdf (headless Chrome)
assets/skill-sheet.pdf     # Japanese skill sheet (JA site's download); assets/cv-en.pdf is the EN site's
